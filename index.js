...
const htmlModalContent=({ id, title, description, url })=> {
    ...
    ${
        // url &&
        // `<img width='100%' scr=${url} alt="Card Image" class='img-fluid place__holder__image mb-3'/> `
...
//we convert json > str(i.e for local storage)
...
//we convert str to json for rending data for card on screen
